...
class $AssetsLottieGen {
  ...
  /// File path: assets/lottie/clear_sunny.json
  LottieGenImage get clearSunny =>
      const LottieGenImage('assets/lottie/clear_sunny.json');

  /// File path: assets/lottie/cloudy.json
  LottieGenImage get cloudy =>
      const LottieGenImage('assets/lottie/cloudy.json');

  /// File path: assets/lottie/drizzle.json
  LottieGenImage get drizzle =>
      const LottieGenImage('assets/lottie/drizzle.json');

  /// File path: assets/lottie/fog.json
  LottieGenImage get fog => const LottieGenImage('assets/lottie/fog.json');

  /// File path: assets/lottie/heavy_rain.json
  LottieGenImage get heavyRain =>
      const LottieGenImage('assets/lottie/heavy_rain.json');

  /// File path: assets/lottie/light_fog.json
  LottieGenImage get lightFog =>
      const LottieGenImage('assets/lottie/light_fog.json');

  /// File path: assets/lottie/light_snow.json
  LottieGenImage get lightSnow =>
      const LottieGenImage('assets/lottie/light_snow.json');
  ...
  /// File path: assets/lottie/partly_cloudy.json
  LottieGenImage get partlyCloudy =>
      const LottieGenImage('assets/lottie/partly_cloudy.json');

  /// File path: assets/lottie/snow.json
  LottieGenImage get snow => const LottieGenImage('assets/lottie/snow.json');

  /// File path: assets/lottie/sunny.json
  LottieGenImage get sunny => const LottieGenImage('assets/lottie/sunny.json');

  /// File path: assets/lottie/thunderstorm.json
  LottieGenImage get thunderstorm =>
      const LottieGenImage('assets/lottie/thunderstorm.json');

  /// File path: assets/lottie/unknown.json
  LottieGenImage get unknown =>
      const LottieGenImage('assets/lottie/unknown.json');
